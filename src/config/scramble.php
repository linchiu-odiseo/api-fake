...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Fake de api.vonex.edu.pe/v3/ para desarrollo. Todas las rutas requieren header X-API-Key o Authorization: Bearer <key>.',
    ],
